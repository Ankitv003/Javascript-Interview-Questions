...
function isAnagramInArray(anagram, arr){
 const sortedAnagram =anagram.toLowerCase().split("").sort().join("").trim()
  return arr.filter((elem)=>{
   return elem.split("").sort().join("").trim() === sortedAnagram
  })
//   return arr.map((elem)=>{
...
// aabbbcceehiillmoorrrstz

// [' aabbbcceehiillmoorrrstz', ' 'aabbbcceehiillmoorrrstz', ' aabbbcceehiillmoorrrstz', ' aabbcceehiillmoorrrstz', ' aabbbcceehiillmoorrrstz', ' aabbbcceehiillmoorrrstz', ' aabbbcceehiillmoorrrstz', ' aaabccdeeeeghhiilmnnrrrstuz', ' aaabccdeeeeghhiilmnnrrrstuz', ' aaabccdeeeeghhiilmnnrrrstuz', ' aaabccdeeeeghhiilmnnrrrstuz', ' aaabccdeeeeghhiilmnnrrrstuz', ' aaabccceehhimmnorrsttt', ' aaabccceehhimmnorrsttt', ' aaabccceehhimmnorrsttt']
